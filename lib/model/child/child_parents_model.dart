...
class ChildParentsModel {
  ...
  factory ChildParentsModel.fromJson(Map<String, dynamic> json) => ChildParentsModel(
  ...
  factory ChildParentsModel.empty() =>
      ChildParentsModel(results: [], previous: "", next: "", count: 0);
}
...
class Result {
  ...
  factory Result.empty() =>
      Result(fullName: "", photo: "", firstName: "", lastName: "", middleName: "", id: 0, relativityType: RelativityType.empty(), contacts: [], files: []);
}
